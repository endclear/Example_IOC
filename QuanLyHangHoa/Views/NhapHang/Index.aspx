...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">
    ...
    <div style="text-align: center; margin: 20px">
        <h4 class="font-weight-bold text-dark">QUẢN LÝ NHẬP HÀNG 2</h4>
    </div>
            ...
            <div class="modal-content">
                <div class="border border-dark p-1 m-5">
                    <div class="modal-header border-bottom-0 pb-0" style="display:block">
                      <h4 class="modal-title text-center " style="font-family:'Times New Roman';font-weight:bold;color:red;font-size:25px">HÓA ĐƠN NHẬP HÀNG</h4>
                      <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                   </div>
                   ...
                   <div class="modal-body row pt-0 mt-3">
                       <div class="col-12">
                           ...
                           <div class="mt-1">
                               <label class="font-weight-bold col-3">Đơn vị bán: </label>
                               <input class="input-create col-8" id="congty" name="congty" readonly="readonly"/>
                           </div>
                       </div>
                       ...
                       <div class="col-12">
                           ...
                           <div class="row mt-4 pl-3 pr-3" >
                               ...
                               <div class="text-right col-8">Đơn vị bán hàng</div>
    ...
    <div style="margin-top: 10px;" id="list-table">
        <button style="float:right;margin: 10px; font-size: 13px" class="btn btn-info" onclick="parent.location='/NhapHang/Create'">Tạo mới</button>
        <table id="myTable" class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        <a href="/NhapHang/Edit/<%:it.id %>" class="btn" <%--class="btn" data-toggle="modal" data-target="#myModal"--%>><i class="fas fa-pen" title="Sửa"></i></a>
                    </td>
                    <td>
    ...
    <script type="text/javascript">
        ...
        function loadDetails(id) {
            $.ajax({
                type: "POST",
                url: "/NhapHang/LoadChiTietPhieuNhap",
                data: { id: id },
                dataType: 'json',
                success: function (Json) {
                    //abc(Json)
                    //console.log(Json);
                    $('.details').html('<thead><tr class="bg-light"><th>Mặt hàng</th> <th>Số lượng</th><th>Giá nhập</th><th>Thành tiền (VND)</th></tr></thead>')
        ...
        function arrayToTable(tableData) {
            ...
            $(tableData).each(function (i, rowData) {
                ...
                row.append($('<td>' + formatNumber(tableData[i].Gianhap,',','.') + '</td>'));
                row.append($('<td>' + formatNumber(tableData[i].Gianhap * tableData[i].Soluong, ',', '.') + '</td>'));
                tongtien = tongtien + tableData[i].Gianhap * tableData[i].Soluong;
                table.append(row);
            });
        ...
        function delete_infor(id) {
            $("#btn_delete_infor").click(function () {
                $.ajax({
                    ...
                    type: 'GET',
                    dataType: 'json',
                    success: location.href = '/NhapHang',
                });
            });
        }
