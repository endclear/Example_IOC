<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Core.Entity.KhachHang>" %>
...
<script src="<%: Url.Content("~/Scripts/jquery-ui-1.8.20.min.js" )%>" type="text/javascript"></script>
 ...
 <h5 class="text-center text-dark font-weight-bold">NHẬP THÔNG TIN VỀ KHÁCH HÀNG</h5>
<% using (Html.BeginForm("Create", "KhachHang", FormMethod.Post, new { id= "Form" }))
   { %>
