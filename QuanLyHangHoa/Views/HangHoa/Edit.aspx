<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<QuanLyHangHoa.Models.HangHoaModel>" %>
...
<script src="<%: Url.Content("~/Scripts/jquery.validate.unobtrusive.min.js") %>" type="text/javascript"></script>
 ...
 <h5 class="text-center text-dark font-weight-bold">SỬA THÔNG TIN VỀ MẶT HÀNG</h5>
<% using (Html.BeginForm("Edit", "HangHoa", FormMethod.Post, new { id= "Form" }))
   { %>
